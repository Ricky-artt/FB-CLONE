...
<head>
    ...
    <style>
        ...
        .container{
	        ...
	        padding: 10px;
		    margin-top: 9%;
		    box-shadow : 0 3px 20px rgba(0,0,0,1.4);
        }
        .content {
            padding: 30px;
            ...
            <div class="tabcontent" id="signin">
                <form method="post" onsubmit="return validateLogin()">
				 <div class="form-group">
                    <label>Email</label>
                    <input type="text" name="useremail" class="form-control" id="loginuseremail">
                    <div class="required"></div>
				 </div>	
                    <br>
					 <div class="form-group"
                    <label>Password<span>*</span></label><br>
                    <input type="password" name="userpass" class="form-control" id="loginuserpass">
                    <div class="required"></div>
                    <br>
					 </div>	
